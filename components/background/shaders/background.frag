...
// Noise function below, copied from glsl-noise (3D simplex noise)
// Inlined manually because glslify-loader doesn't support PnP yet
// Scroll to line of ***** to see actual code
