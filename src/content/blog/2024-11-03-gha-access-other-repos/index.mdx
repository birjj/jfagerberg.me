---
title: GitHub Actions - Accessing other repos
date: 2024-11-03
updated: 2025-10-20
...
import ChallengeDiagram from "./challenge.excalidraw.svg?raw";

<Figure>
  <Fragment set:html={ChallengeDiagram} />
</Figure>
...
import ShortLivedDiagram from "./short-lived.excalidraw.svg?raw";

<Figure>
  <Fragment set:html={ShortLivedDiagram} />
</Figure>
