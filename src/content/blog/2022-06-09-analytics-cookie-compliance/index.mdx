...
<Aside>
  Note: this article has been updated on 2025-01-16 after the release of the EDPB 2023 Guidelines. The original slightly more rambling version, which reaches the same conclusion by analyzing the law instead of the guidelines, is available [here](./old).
</Aside>
