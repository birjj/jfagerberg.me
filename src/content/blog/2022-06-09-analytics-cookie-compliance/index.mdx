...
There is of course also the aspect of interpretation. The EDPB seems to have taken a hardliner approach, considering Article 5(3) of the ePD to apply in many edge cases. Plausible has an incentive to lean the other direction. The various Data Protection Agencies across the EU are likely to have their own interpretation. Until a court has taken a stance on the issue I don't think we can get much closer to a definitive answer on who is right.
