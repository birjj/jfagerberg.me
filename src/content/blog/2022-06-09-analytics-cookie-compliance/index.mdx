...
<dl>
  ...
  <dd>
    Directive from 2002, later amended in 2009. One of the early attempts at legislating online privacy. Puts rather strict limits on **_accessing or processing any data_** from end-user devices without requiring informed consent from the user. This is regardless of whether the data is personal or not.
