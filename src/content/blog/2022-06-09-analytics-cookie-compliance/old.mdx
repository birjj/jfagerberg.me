...
<Aside>
  Note: this article has been updated on 2025-01-16 after the release of the EDPB 2024 Guidelines. The new version, which reaches the same conclusion in less words, is available [here](./index.mdx).
</Aside>
